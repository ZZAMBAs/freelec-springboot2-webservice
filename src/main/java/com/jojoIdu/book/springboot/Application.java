...
// @EnableJpaAuditing (실습을 함에 따라 제거. JpaConfig로 분리.) // JPA Auditing 활성화. JPA Auditing: https://webcoding-start.tistory.com/53
...
public class Application { // 프로젝트의 메인 클래스.
    public static void main(String[] args){
        ...
        // 2020.12 기준: https://jojoldu.tistory.com/539
    }
}
